...
- publishing others' private information, such as a physical or email address,
  without explicit permission; and
...
Examples include using an official account, posting through an official social
media account, or acting as an appointed representative at an event.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported privately to the repository owner through a private contact method on
the owner's GitHub profile. If the report also involves a security or privacy
vulnerability, use the private process in [SECURITY.md](SECURITY.md). Do not
publish a victim's private information in an Issue.

All complaints will be reviewed and investigated promptly and fairly to the
extent possible for a volunteer project. Community leaders will respect the
